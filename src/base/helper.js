...
// export default function getBulmaClasses(vars) {
...
//   vars['sizes'].forEach((size, i) => {
//     helpers[`is-size-${i + 1}`] = css`
//       font-size: ${size};
//     `
//   })
...
//     vars['sizes'].forEach((size, i) => {
//       helpers[`is-size-${i + 1}-${target}`] = tag(css`
//         font-size: ${size};
//       `)
//     })
//   }
...
//   helpers['is-marginless'] = 'margin: 0 !important;'

//   helpers['is-paddingless'] = 'padding: 0 !important;'

//   helpers['is-radiusless'] = 'border-radius: 0 !important;'

//   helpers['is-shadowless'] = 'box-shadow: none !important;'

//   helpers['is-unselectable'] = unselectable
